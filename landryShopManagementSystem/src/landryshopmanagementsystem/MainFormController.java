...
import static landryshopmanagementsystem.data.username;
...
public class MainFormController implements Initializable {
   ...
   public class mainFormController implements Initializable {
    ...
    @FXML
    private TableColumn<?, ?> order_col_qty;
    ...
    @FXML
    private TableColumn<?, ?> service_col_DI;
    ...
    @FXML
    private TableColumn<?, ?> service_col_clothType;

    @FXML
    private TableColumn<?, ?> service_col_id;
    ...
    @FXML
    private TableView<?> service_tableView;
    ...
    @FXML
    void servicesClearBtn(ActionEvent event) {

    }

    @FXML
    void servicesDeleteBtn(ActionEvent event) {

    }

    @FXML
    void servicesImportBtn(ActionEvent event) {
    ...
    @FXML
    void servicesSelectData(MouseEvent event) {

    }

    @FXML
    void servicesUpdateBtn(ActionEvent event) {
...
//                java.sql.Date sqlDate = new java.sql.Date(date.getTime());
    ...
    private final String[] servicesList = {"Washing", "Washing and Drying", "Washing, Drying and Ironing"};

    public void servicesServiceList() {

        List<String> listS = new ArrayList<>();

        listS.addAll(Arrays.asList(servicesList));
    ...
    public void servicesShowData() {
        ...
        services_col_id.setCellValueFactory(new PropertyValueFactory<>("serviceID"));
        services_col_clothType.setCellValueFactory(new PropertyValueFactory<>("clothType"));
        services_col_service.setCellValueFactory(new PropertyValueFactory<>("service"));
        services_col_PPK.setCellValueFactory(new PropertyValueFactory<>("pricePerKilo"));
        services_col_DI.setCellValueFactory(new PropertyValueFactory<>("date"));
        services_col_DU.setCellValueFactory(new PropertyValueFactory<>("uDate"));
    ...
    public void servicesSelectData() {
        ...
        getServices getS = services_tableView.getSelectionModel().getSelectedItem();
        ...
        services_id.setText(getS.getServiceID());
        services_PPK.setText(String.valueOf(getS.getPricePerKilo()));
...
//    CUSTOMERS FORM
    ...
    public void switchForm(ActionEvent event) {
       boolean dashboard_btn = false;
       boolean order_btn = false;
